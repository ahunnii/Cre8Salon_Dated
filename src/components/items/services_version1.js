...
class Services extends Component {
  ...
  componentDidMount() {
    sr.reveal(this.services, srConfig());
  ...
  render() {
    ...
    const parallaxImage =
      'https://scontent-ort2-2.xx.fbcdn.net/v/t1.0-9/29543130_1495443247251190_899218474709824559_n.jpg?_nc_cat=107&_nc_ht=scontent-ort2-2.xx&oh=a6b36ad16e69e75f64f00eea397a4181&oe=5C9EC4CF';
      ...
      <div>
        ...
        <ProjectsContainer>
          <Paragraph>
            ...
            venenatis lectus. Blandit volutpat maecenas volutpat blandit aliquam etiam erat.
            Convallis posuere morbi leo urna molestie at elementum eu. Nibh ipsum consequat nisl vel
            pretium lectus.
          </Paragraph>
          <ProjectsGrid>
            <TransitionGroup className="projects">
              {projectsToShow &&
                projectsToShow.map(({ node }, i) => {
                  ...
                  const { image, github, external, title } = frontmatter;
                  return (
                    <CSSTransition
                      key={i}
                      classNames="fadeup"
                        ...
                        <ProjectInner>
                          <ProjectTop>
                            ...
                            <ProjectName>
                              ...
                              <ProjectPara>
                                <PriceModal cre={html} style="z-index:50;"></PriceModal>
                              </ProjectPara>
                            </ProjectName>
