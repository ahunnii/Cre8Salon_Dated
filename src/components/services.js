...
const Project = styled.div`
  ...
  hr {
    ...
    box-shadow: -1px -1px 1px #111, 2px 2px 1px ${theme.colors.backgroundGrey};
    height: 2px;
  }
  table {
    width: 100%;
  ...
  render() {
    ...
    return (
      <ProjectsContainer>
        ...
        <Disclaimer>
          *Note that prices may vary due to hair length, density, technique and stylist experience
        </Disclaimer>
        <ProjectsGrid>
